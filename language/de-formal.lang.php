...
$lang["notice"] = "Es sieht so aus, als würde Ihr Browser JavaScript nicht unterstützen. Das führt dazu, dass einige Funktionen nicht funtionieren.";
...
$lang["title"]["recent"] = "Neueste - Seite $pagination"; // Recent Page Title
...
// Imagine $release is a name, like Succubus.Cafe-DARKSiDERS or so
...
$lang["recent"]["view_all"] = "Sehen Sie alle Releases"; // View all Releases Button
...
$lang["release"]["released"] = "Veröffentlicht am $date"; // Shows before release date
// Imagine $author is a name, like saintly
$lang["release"]["by"] = "Von $author"; // Shows before Author
$lang["release"]["search_author"] = "Alle Releases vom Author suchen"; // Shows after Author's name
// Imagine $cat is a category, like games
$lang["release"]["cat"] = "In Kategory $cat"; // Shows before Category
...
$lang["admin"]["home"]["welcome"] = "Willkommen, $username"; // Welcome greeting, $username will always be last
...
$lang["admin"]["cats"]["cannot_id"] = "Sie können die ID nicht bearbeiten!"; // Can not edit id text
...
$lang["admin"]["cats"]["delete_sure"] = "Sind Sie sicher?"; // Text shown at modal title
...
$lang["admin"]["cats"]["total"] = "$number Kat."; // Total number of Categories
...
$lang["admin"]["cats"]["form_cat_short"] = "Kürzel"; // Category Short text
$lang["admin"]["cats"]["form_add_cat"] = "Füge Kategorie hinzu!"; // Add Cat button

/* ADMIN LOGIN PAGE */
$lang["admin"]["login"]["error"] = "Oh... das Passwort oder der Nutzername ist falsch."; // Error if details wrong
...
$lang["admin"]["release"]["ph_description"] = "Worüber ist das Release? Was beinhaltet es? Erzählen Sie hier mehr darüber..."; // Placeholder for textarea/input
...
$lang["admin"]["release"]["no_category"] = "Sie haben noch keine kategorien erstellt."; // If no Cats exist
...
$lang["admin"]["settings"]["ph_folder"] = "Hefter wo das System ist, wenn domain.com/haha/, dann haha/"; // Placeholder of folder/Sub-Directory
$lang["admin"]["settings"]["language"] = "Sprache"; // Language selector
$lang["admin"]["settings"]["save"] = "Konfiguration sichern!"; // Save Button
$lang["admin"]["settings"]["notice"] = "Wenn die änderungen nach dem sichern nicht in kraft treten, laden Sie die Seite neu. Wenn sie nach zweimaligem neuladen immer noch nicht erscheinen, machen Sie sie bitte erneut."; // Notice at the bottom
$lang["admin"]["settings"]["refreshing"] = "Warten Sie kurz, die Seite läd neu in zwei Sekunden!"; // Shows after saving config
