...
$lang["title"]["recent"] = "Recent - Page $pagination"; // Recent Page Title
...
$lang["release"]["released"] = "Released on $date"; // Shows before release date
// Imagine $author is a name, like saintly
$lang["release"]["by"] = "By $author"; // Shows before Author
$lang["release"]["search_author"] = "Search all Releases by Author"; // Shows after Author's name
// Imagine $cat is a category, like games
$lang["release"]["cat"] = "In Category $cat"; // Shows before Category
...
$lang["admin"]["home"]["welcome"] = "Welcome, $username"; // Welcome greeting, $username will always be last
...
$lang["admin"]["cats"]["total"] = "$number Cats."; // Total number of Categories
