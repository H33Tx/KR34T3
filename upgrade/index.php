...
$notes = file_get_contents("https://cdn.henai.eu/KR34T3/versions/$latest/note.txt");
if(empty($notes)) {
...
if($current===$latest) {
    die("<p><b style='color:green'>Your System is up-to-date!</b> (Local: <span style='color:red'>$current</span>, Latest: <span style='color:green'>$latest</span>)</p><hr><p><u>Important Notes:</u></p><pre>$notes</pre><hr><p><u>Changelog:</u></p><pre>$changelog</pre><hr><p>&copy; 2021-2022 Project H33T x HENAI.eu</p>");
}
